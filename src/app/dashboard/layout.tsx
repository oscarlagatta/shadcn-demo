    ...
    return (
        <>
            ...
            <div className="flex overflow-hidden bg-white pt-16 dark:bg-slate-900 dark:border-slate-700">
                ...
                <div
                    id="main-content"
                    className="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64 dark:bg-slate-800 dark:border-slate-900"
                >
                    <main>
                    ...
                    <footer
                        className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 print:hidden dark:bg-slate-800">
